...
use zingolib::testutils::lightclient::get_fees_paid_by_client;
...
// requires one copy of this protection in the default suite. When the
// twin revives, this live original returns behind the unit_test_twins
// gate.
#[tokio::test]
