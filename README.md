...
* Currently, the default, hard-coded `lightwalletd` server is https://lwdv3.zecwallet.co:443/. To change this, you can modify the `DEFAULT_SERVER` const in `config/src/lib.rs`
