...
pub const INDEXERS: &[Indexer] = &[
    Indexer {
        ...
        chain: IndexerChain::Main,        region_key: "usa",
        default: true,
        obsolete: false,
    },
    Indexer {
        uri: "https://na.zec.rocks:443",
        chain: IndexerChain::Main,        region_key: "na",
        default: false,
        obsolete: false,
    },
    Indexer {
        uri: "https://sa.zec.rocks:443",
        chain: IndexerChain::Main,        region_key: "sa",
        default: false,
        obsolete: false,
    },
    Indexer {
        uri: "https://eu.zec.rocks:443",
        chain: IndexerChain::Main,        region_key: "ea",
        default: false,
        obsolete: false,
    },
    Indexer {
        uri: "https://ap.zec.rocks:443",
        chain: IndexerChain::Main,        region_key: "ao",
        default: false,
        obsolete: false,
    },
    Indexer {
        uri: DEFAULT_INDEXER_URI_TESTNET,
        chain: IndexerChain::Test,        region_key: "",
        default: true,
        obsolete: false,
    },
    ...
    Indexer {
        ...
        chain: IndexerChain::Main,        region_key: "hk",
        default: false,
        obsolete: true,
    },
    Indexer {
    ...
    Indexer {
        ...
        chain: IndexerChain::Main,        region_key: "canada",
        default: false,
        obsolete: true,
    },
    Indexer {
        uri: "https://lwd5.zcash-infra.com:9067",
        chain: IndexerChain::Main,        region_key: "france",
        default: false,
        obsolete: true,
    },
    Indexer {
    ...
    Indexer {
        ...
        chain: IndexerChain::Main,        region_key: "netherlands",
        default: false,
        obsolete: true,
    },
    Indexer {
        uri: "https://lwd8.zcash-infra.com:9067",
        chain: IndexerChain::Main,        region_key: "uk",
        default: false,
        obsolete: true,
    },
    Indexer {
    ...
    Indexer {
        ...
        chain: IndexerChain::Main,        region_key: "",
        default: false,
        obsolete: false,
    },
    Indexer {
