...
pub struct Indexer {
    ...
    /// The operating party, by the label consumers group on (operator
    /// disjointness for the mixnet fan-out keys on this field).
