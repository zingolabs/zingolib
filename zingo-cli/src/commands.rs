...
//! for commands that run without a wallet). Commands are split into two
//! categories — standalone and wallet — and registered in
//! [`get_standalone_commands`] / [`get_wallet_commands`] respectively.
