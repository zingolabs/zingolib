...
Flags are now more functional. (https://github.com/zingolabs/zingolib/issues/17)
...
It currently takes 15 seconds to do so, to give the daemons time to boot, but this will be shortened soon.
...
and the interactive cli application should work with your regtest network.
...
* it's not, unfortunately. You must add absolute paths to several places in the source code itself until I get directory sniffing working.
Lines 66, 67, 100, 102, 104, 106 in cli/main.rs all need complete paths for now.
