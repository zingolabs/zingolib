//! The value-transfer family: the editorial per-recipient view of a
//! transaction, moved verbatim from zingolib's summary layer.
...
use zingolib::wallet::summary::data::TransactionSummary;
