...
pub enum MainnetSeedVersion {
    ...
    VTFCORFBCBPCTCFUPMEGMWBP(VTFCORFBCBPCTCFUPMEGMWBPVersion),
    /// empty mainnet wallet
    HHCCLALTPCCKCSSLPCNETBLR(HHCCLALTPCCKCSSLPCNETBLRVersion),
}
/// /
#[non_exhaustive]
#[derive(Clone)]
pub enum VTFCORFBCBPCTCFUPMEGMWBPVersion {
...
#[non_exhaustive]
#[derive(Clone)]
pub enum HHCCLALTPCCKCSSLPCNETBLRVersion {
    /// wallet was last saved in this serialization version
    Gf0aaf9347,
...
pub enum TestnetSeedVersion {
    ...
    CBBHRWIILGBRABABSSHSMTPR(CBBHRWIILGBRABABSSHSMTPRVersion),
    /// This is a testnet seed, generated by fluidvanadium at the beginning of owls (this example wallet enumeration)
    MSKMGDBHOTBPETCJWCSPGOPP(MSKMGDBHOTBPETCJWCSPGOPPVersion),
}
/// /
#[non_exhaustive]
#[derive(Clone)]
pub enum MSKMGDBHOTBPETCJWCSPGOPPVersion {
...
#[non_exhaustive]
#[derive(Clone)]
pub enum CBBHRWIILGBRABABSSHSMTPRVersion {
    /// wallet was last saved in this serialization version
    V26,
    /// wallet was last saved in this serialization version
    V27,
...
pub enum RegtestSeedVersion {
    ...
    HMVASMUVWMSSVICHCARBPOCT(HMVASMUVWMSSVICHCARBPOCTVersion),
    /// this is a regtest wallet originally called v26/sap_only
    AAAAAAAAAAAAAAAAAAAAAAAA(AAAAAAAAAAAAAAAAAAAAAAAAVersion),
    /// another regtest wallet
    AADAALACAADAALACAADAALAC(AADAALACAADAALACAADAALACVersion),
}
/// /
#[non_exhaustive]
#[derive(Clone)]
pub enum HMVASMUVWMSSVICHCARBPOCTVersion {
    /// wallet was last saved in this serialization version
    V27,
}
/// /
#[non_exhaustive]
#[derive(Clone)]
pub enum AAAAAAAAAAAAAAAAAAAAAAAAVersion {
    /// wallet was last saved in this serialization version
    V26,
}
/// /
#[non_exhaustive]
#[derive(Clone)]
pub enum AADAALACAADAALACAADAALACVersion {
    /// existing receivers?
    OrchAndSapl,
    /// existing receivers?
    OrchOnly,
...
impl NetworkSeedVersion {
    ...
    pub async fn load_example_wallet(&self) -> LightWallet {
        match self {
            NetworkSeedVersion::Regtest(seed) => match seed {
                RegtestSeedVersion::HMVASMUVWMSSVICHCARBPOCT(version) => match version {
                ...
                RegtestSeedVersion::AAAAAAAAAAAAAAAAAAAAAAAA(version) => match version {
                ...
                RegtestSeedVersion::AADAALACAADAALACAADAALAC(version) => match version {
            ...
            NetworkSeedVersion::Testnet(seed) => match seed {
                TestnetSeedVersion::CBBHRWIILGBRABABSSHSMTPR(version) => match version {
                ...
                TestnetSeedVersion::MSKMGDBHOTBPETCJWCSPGOPP(version) => match version {
            ...
            NetworkSeedVersion::Mainnet(seed) => match seed {
                MainnetSeedVersion::VTFCORFBCBPCTCFUPMEGMWBP(version) => match version {
                ...
                MainnetSeedVersion::HHCCLALTPCCKCSSLPCNETBLR(version) => match version {
    ...
    pub fn example_wallet_base(&self) -> String {
        match self {
            NetworkSeedVersion::Regtest(seed) => match seed {
                RegtestSeedVersion::HMVASMUVWMSSVICHCARBPOCT(_) => {
                    crate::testvectors::seeds::HOSPITAL_MUSEUM_SEED.to_string()
                },
                RegtestSeedVersion::AAAAAAAAAAAAAAAAAAAAAAAA(_) => {
                    crate::testvectors::seeds::ABANDON_ART_SEED.to_string()
                },
                RegtestSeedVersion::AADAALACAADAALACAADAALAC(_) => {
            ...
            NetworkSeedVersion::Testnet(seed) => match seed {
                TestnetSeedVersion::CBBHRWIILGBRABABSSHSMTPR(
                    _,
                ) => crate::testvectors::seeds::CHIMNEY_BETTER_SEED.to_string(),
                TestnetSeedVersion::MSKMGDBHOTBPETCJWCSPGOPP(
                    _,
            ...
            NetworkSeedVersion::Mainnet(seed) => match seed {
                MainnetSeedVersion::VTFCORFBCBPCTCFUPMEGMWBP(
                     _,
                ...
                MainnetSeedVersion::HHCCLALTPCCKCSSLPCNETBLR(
                     _,
    ...
    pub fn example_wallet_address(&self, pool: PoolType) -> String {
        match pool {
            PoolType::Transparent => match self {
                NetworkSeedVersion::Regtest(seed) => match seed {
                    RegtestSeedVersion::HMVASMUVWMSSVICHCARBPOCT(_) => {"tmFLszfkjgim4zoUMAXpuohnFBAKy99rr2i".to_string()},
                    RegtestSeedVersion::AAAAAAAAAAAAAAAAAAAAAAAA(_) => {"tmBsTi2xWTjUdEXnuTceL7fecEQKeWaPDJd".to_string()},
                    RegtestSeedVersion::AADAALACAADAALACAADAALAC(_) => {"tmS9nbexug7uT8x1cMTLP1ABEyKXpMjR5F1".to_string()},
                },
                NetworkSeedVersion::Testnet(seed) => match seed {
                    TestnetSeedVersion::CBBHRWIILGBRABABSSHSMTPR(_) => {"tmYd5GP6JxUxTUcz98NLPumEotvaMPaXytz".to_string()},
                    TestnetSeedVersion::MSKMGDBHOTBPETCJWCSPGOPP(_) => {"tmEVmDAnveCakZkvV4a6FT1TfYApTv937E7".to_string()},
                },
                NetworkSeedVersion::Mainnet(seed) => match seed {
                    MainnetSeedVersion::VTFCORFBCBPCTCFUPMEGMWBP(_) => {"t1P8tQtYFLR7TWsqtauc71RGQdqqwfFBbb4".to_string()},
                    MainnetSeedVersion::HHCCLALTPCCKCSSLPCNETBLR(_) => {"t1XnsupYhvhSDSFJ4nzZ2kADhLMR22wg35y".to_string()},
                }
            },
            PoolType::Shielded(ShieldedProtocol::Sapling) => match self {
                NetworkSeedVersion::Regtest(seed) => match seed {
                    RegtestSeedVersion::HMVASMUVWMSSVICHCARBPOCT(_) => {"zregtestsapling1fkc26vpg566hgnx33n5uvgye4neuxt4358k68atnx78l5tg2dewdycesmr4m5pn56ffzsa7lyj6".to_string()},
                    RegtestSeedVersion::AAAAAAAAAAAAAAAAAAAAAAAA(_) => {"zregtestsapling1fmq2ufux3gm0v8qf7x585wj56le4wjfsqsj27zprjghntrerntggg507hxh2ydcdkn7sx8kya7p".to_string()},
                    RegtestSeedVersion::AADAALACAADAALACAADAALAC(_) => {"zregtestsapling1lhjvuj4s3ghhccnjaefdzuwp3h3mfluz6tm8h0dsq2ym3f77zsv0wrrszpmaqlezm3kt6ajdvlw".to_string()},
                },
                NetworkSeedVersion::Testnet(seed) => match seed {
                    TestnetSeedVersion::CBBHRWIILGBRABABSSHSMTPR(_) => {"ztestsapling1etnl5s47cqves0g5hk2dx5824rme4xv4aeauwzp4d6ys3qxykt5sw5rnaqh9syxry8vgxu60uhj".to_string()},
                    TestnetSeedVersion::MSKMGDBHOTBPETCJWCSPGOPP(_) => {"ztestsapling1h8l5mzlwhmqmd9x7ehquayqckzg6jwa6955f3w9mnkn5p5yfhqy04yz6yjrqfcztxx05xlh3prq".to_string()},
                }
                NetworkSeedVersion::Mainnet(seed) => match seed {
                    MainnetSeedVersion::VTFCORFBCBPCTCFUPMEGMWBP(_) => {"zs1kgdrzfe6xuq3tg64vnezp3duyp43u7wcpgduqcpwz9wsnfqm4cecafu9qkmpsjtqxzf27n34z9k".to_string()},
                    MainnetSeedVersion::HHCCLALTPCCKCSSLPCNETBLR(_) => {"zs1zgffhwsnh7efu4auv8ql9egteangyferp28rv8r7hmu76u0ee8mthcpflx575emx2zygqcuedzn".to_string()},
                }
            },
            PoolType::Shielded(ShieldedProtocol::Orchard) => match self {
                ...
                NetworkSeedVersion::Testnet(example_test_seed) => match example_test_seed {
                    TestnetSeedVersion::CBBHRWIILGBRABABSSHSMTPR(_) => {
                    ...
                    TestnetSeedVersion::MSKMGDBHOTBPETCJWCSPGOPP(_) => {
                ...
                NetworkSeedVersion::Mainnet(example_test_seed) => match example_test_seed {
                    MainnetSeedVersion::VTFCORFBCBPCTCFUPMEGMWBP(_) => {
                    ...
                    MainnetSeedVersion::HHCCLALTPCCKCSSLPCNETBLR(_) => {
