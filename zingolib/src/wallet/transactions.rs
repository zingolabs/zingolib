...
pub mod trait_walletread {
    ...
    impl WalletRead for TxMapAndMaybeTrees {
        ...
        fn get_min_unspent_height(
            ...
            Ok(self.transaction_records_by_id.values().fold(
                None,
                |height_rolling_min, transaction| {
        ...
        fn get_wallet_summary(
            ...
            Option<zcash_client_backend::data_api::WalletSummary<Self::AccountId>>,
            Self::Error,
        > {
            unimplemented!()
        }
    ...
    mod tests {
        ...
        fn get_target_and_anchor_heights() {
            ...
            let mut transaction_records_and_maybe_trees =
                TxMapAndMaybeTrees::new_with_witness_trees();
