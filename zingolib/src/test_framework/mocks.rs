...
pub mod proposal {
    ...
    use crate::wallet::notes::OutputRecord;
    ...
    pub struct ProposalBuilder {
        ...
        steps: Option<NonEmpty<Step<OutputRecord>>>,
    }
    ...
    impl ProposalBuilder {
        ...
        build_method!(steps, NonEmpty<Step<OutputRecord>>);
        ...
        pub fn build(self) -> Proposal<FeeRule, OutputRecord> {
    ...
    pub struct StepBuilder {
        ...
        shielded_inputs: Option<Option<ShieldedInputs<OutputRecord>>>,
    ...
    impl StepBuilder {
        ...
        build_method!(shielded_inputs, Option<ShieldedInputs<OutputRecord>>);
        ...
        /// due to invalid values.
        #[allow(dead_code)]
        pub fn build(self) -> Step<OutputRecord> {
            Step::from_parts(
                &[],
