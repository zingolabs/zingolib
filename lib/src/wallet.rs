...
impl LightWallet {
    ...
    pub(crate) fn note_address<D: DomainWalletExt<zingoconfig::BlockChain>>(
        network: &zingoconfig::BlockChain,
        note: &D::WalletNote,
    ...
    async fn select_notes_and_utxos(
        ...
        if prefer_orchard_over_sapling {
            let sapling_candidates = self
                .get_all_domain_specific_notes::<SaplingDomain<zingoconfig::BlockChain>>()
                .await;
            (sapling_notes, sapling_value_selected) =
                Self::add_notes_to_total::<SaplingDomain<zingoconfig::BlockChain>>(
                    sapling_candidates,
    ...
    fn add_notes_to_total<D: DomainWalletExt<zingoconfig::BlockChain>>(
